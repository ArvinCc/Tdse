 ...
 */
public class TdseHttpHandler extends SimpleChannelInboundHandler<Object>
{
    ...
    public void channelRead0(ChannelHandlerContext ctx, Object msg)
    {
        try {
            if (msg instanceof FullHttpRequest) {
                FullHttpRequest o=(FullHttpRequest) msg;
                handleHttpRequest(ctx, o);
                //if (o.method()==GET){
                   // ctx.fireChannelRead(msg);
//                    final String uri = o.uri();
//
//                    String[] p = o.uri().split("/");
//                    System.out.println("Get请求"+uri+"第一个"+p[0]);
//                    if(p[1].equals("DownLoad"))
//                    {
//                        ctx.fireChannelRead(msg);
//                    }
               // }else if (o.method()==POST)
                if (o.method()==POST)
                {
                    ByteBuf buf = o.content();
                    byte[] req = new byte[buf.readableBytes()];
                    buf.readBytes(req);
                    HttpEventManager.getInstance().postOrder(new String(req,"UTF-8"));
                }
